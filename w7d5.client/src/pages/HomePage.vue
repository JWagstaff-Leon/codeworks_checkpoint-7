<template>
    ...
    <div v-else>
        ...
        <ul class="nav nav-tabs mt-4 mb-3 border-danger no-select no-drag">
            <li class="nav-item rounded-top" @click="tab = ''" :class="{active: tab === '', 'border-danger': tab !== '', 'border-info': tab === '', 'bg-info': tab === ''}">
                <span class="nav-link" :class="{'text-dark': tab === '', 'text-primary': tab !== ''}">All</span>
            </li>
            <li class="nav-item rounded-top" @click="tab = 'concert'" :class="{active: tab === 'concert', 'border-danger': tab !== 'concert', 'border-info': tab === 'concert', 'bg-info': tab === 'concert'}">
                <span class="nav-link" :class="{'text-dark': tab === 'concert', 'text-primary': tab !== 'concert'}">Concerts</span>
            </li>
            <li class="nav-item rounded-top" @click="tab = 'convention'" :class="{active: tab === 'convention', 'border-danger': tab !== 'convention', 'border-info': tab === 'convention', 'bg-info': tab === 'convention'}">
                <span class="nav-link" :class="{'text-dark': tab === 'convention', 'text-primary': tab !== 'convention'}">Conventions</span>
            </li>
            <li class="nav-item rounded-top" @click="tab = 'sport'" :class="{active: tab === 'sport', 'border-danger': tab !== 'sport', 'border-info': tab === 'sport', 'bg-info': tab === 'sport'}">
                <span class="nav-link" :class="{'text-dark': tab === 'sport', 'text-primary': tab !== 'sport'}">Sport Events</span>
            </li>
            <li class="nav-item rounded-top" @click="tab = 'digital'" :class="{active: tab === 'digital', 'border-danger': tab !== 'digital', 'border-info': tab === 'digital', 'bg-info': tab === 'digital'}">
